...
if (!isset($_SESSION["hospital_id"])) {
    header("Location: ../login/hopital_admin.php");
    exit();
}
?>
<!DOCTYPE html>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <header>
    ...
    <div class="header_right">
        <a class="btn" href="#">Se déconnecter</a>
  ...
  <div class="sidebar">
    ...
    <button data-section="doctorsSection">Ajouter un doctor</button>
    <button data-section="demandessSection">recherche un patient</button>
  </div>
  ...
  <div class="content">
    ...
    <div id="formSection" class="hidden">
      ...
      <form method="POST" action="./add_pasient.php" enctype="multipart/form-data">
